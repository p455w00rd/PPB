        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Tambah Barang ditemukan</div>

                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{route('temu.store')}}">
                            {{ csrf_field() }}
                            ...
                            <input type="text" hidden value="1" name="tipe">
